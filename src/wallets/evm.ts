...
export type EvmWalletOptions = EvmWalletPrivateKeyOptions | EvmWalletMnemonicOptions;
...
export class EvmWallet {
  ...
  constructor(options: EvmWalletOptions) {
    ...
    if (hasKey && hasMnemonic) {
      throw new Error("EvmWallet accepts only one of 'privateKey' or 'mnemonic'.");
    }
  ...
  private async _accountFromMnemonic() {
